...
import { Trash2, Copy, X, Play } from "lucide-react";
...
export function PropertiesPanel() {
  ...
  if (!node) {
    return (
      <div className="flex items-center justify-center h-32 text-[#525252] text-[11px] px-4 text-center">
    ...
    <div className="space-y-3" data-testid="properties-panel">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="text-[10px] font-medium uppercase tracking-wider text-[#525252]">Properties</span>
        ...
        <Button size="icon" variant="ghost" className="h-5 w-5 text-[#525252] hover:text-[#a1a1aa]"
          onClick={() => setSelectedNodeId(null)} data-testid="button-close-properties">
          <X className="w-3 h-3" />
        </Button>
      </div>
      ...
      <div className="space-y-1">
        ...
        <Input value={data.label} onChange={(e) => updateNodeData(node.id, { label: e.target.value })}
          className="h-7 text-[11px] bg-[#0f0f0f] border-[#2a2a2a] text-[#e4e4e7] focus:border-[#3f3f46]"
        ...
        <>
          <div className="space-y-1">
            ...
            <Select value={(data.config.model as string) || "cloud-ru-auto"}
              ...
              <SelectTrigger className="h-7 text-[11px] bg-[#0f0f0f] border-[#2a2a2a]" data-testid="select-model">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-1">
            ...
            <Input type="number" value={(data.config.maxTokens as number) ?? 2048}
              ...
              className="h-7 text-[11px] bg-[#0f0f0f] border-[#2a2a2a] text-[#e4e4e7]" />
          </div>
          <div className="space-y-1">
        ...
        <>
          <div className="space-y-1">
            ...
            <Select value={(data.config.language as string) || "python"}
              ...
              <SelectTrigger className="h-7 text-[11px] bg-[#0f0f0f] border-[#2a2a2a]">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between">
              ...
              <Button size="sm" variant="ghost"
                className="h-5 text-[9px] text-[#84cc16] hover:text-[#a3e635] gap-1 px-1.5"
      ...
      <div className="flex gap-2">
        <Button variant="outline" size="sm"
          className="flex-1 text-[10px] h-7 border-[#2a2a2a] bg-[#0f0f0f] text-[#a1a1aa] hover:bg-[#1e1e1e]"
          onClick={() => duplicateNode(node.id)}>
          <Copy className="w-3 h-3 mr-1" /> Duplicate
        </Button>
        <Button variant="outline" size="sm"
          className="flex-1 text-[10px] h-7 border-red-900/30 bg-red-950/20 text-red-400 hover:bg-red-950/40"
